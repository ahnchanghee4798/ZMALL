        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <DeliveryStatus :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" @add="append" v-if="tick"/>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            headers: 
                [
                    ...
                    { text: "pickedTime", value: "pickedTime" },
                ],
            deliveryStatus : [],
            newValue: {},
            tick : true,
        ...
        async created() {
            ...
            this.values = temp.data._embedded.deliverystatuses;
